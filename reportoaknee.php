        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="col">
                                    <div class="card text-center border-primary">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            <h1 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"] >= 2) {
                                                echo "มีโอกาสที่จะเป็นโรคข้อเข่าเสื่อม";
                                            }else {
                                                echo "ผลปกติ";
                                            }
                                            ?>
                    ...
                    <hr>
                    <p class="text-right">ที่มา : คู่มือคัดกรองและประเมินสุขภาพผู้สูงอายุ กระทรวงสาธารณสุข, 2564</p>
