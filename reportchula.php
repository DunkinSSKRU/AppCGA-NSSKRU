                                ...
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"] <=4 ) {
                                                echo "ความสามารถในการปฏิบัติกิจวัตรประจำวันน้อย (ติดเตียง)";
                                                echo "<br/>";
                                                echo "ควรประเมินอย่างน้อยปีละ 1 ครั้ง ขึ้นอยู่กับสภาพการเปลี่ยนแปลงของผู้สูงอายุ";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"] <=8 ) {
                                                echo "ความสามารถในการปฏิบัติกิจวัตรประจำวันปานกลาง (ติดบ้าน)";
                                                echo "<br/>";
                                                echo "ควรประเมินอย่างน้อยปีละ 1 ครั้ง ขึ้นอยู่กับสภาพการเปลี่ยนแปลงของผู้สูงอายุ";
                                            }else {
                                                echo "ผูความสามารถในการปฏิบัติกิจวัตรประจำวันมาก (ติดสังคม)";
                                                echo "<br/>";
                                                echo "ควรประเมินอย่างน้อยปีละ 1 ครั้ง ขึ้นอยู่กับสภาพการเปลี่ยนแปลงของผู้สูงอายุ";
                                            }
                                            ?>
