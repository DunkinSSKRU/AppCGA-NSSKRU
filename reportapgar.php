            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แบบประเมินการได้รับการสนับสนุนจากครอบครัว 5 ด้าน (The Family APGAR Questionnaire)</h1>
                    </div>
                        <div class="container">
                            <div class="row">
                                <!-- <div class="col"></div> -->
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            $_POST["four"];
                                            $_POST["five"];
                                            echo $_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"];
                                            ?>
                                            </h1><br>
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"] <=3 ) {
                                                echo "หมายถึง"; 
                                                echo "<br/>";
                                                echo "ผู้สูงอายุได้รับการสนับสนุน";
                                                echo"<font color='green'>ระดับต่ำมาก</font>";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"] <=7 ) {
                                                echo "หมายถึง"; 
                                                echo "<br/>";
                                                echo "ผู้สูงอายุได้รับการสนับสนุน";
                                                echo"<font color='orange'>ระดับปานกลาง</font>";
                                            }else {
                                                echo "หมายถึง"; 
                                                echo "<br/>";
                                                echo "ผู้สูงอายุได้รับการสนับสนุน";
                                                echo"<font color='red'>ระดับระดับสูง</font>";
                                            }
                                            ?>
                                            </h3><br>
                                        </div>
                    ...
                    <hr>
                    <p class="text-right">ที่มา : Smilkstein, Ashworth, & Montano, 1982 แปลไทยโดย พรทิพย์ มาลาธรรม, 2544</p>
