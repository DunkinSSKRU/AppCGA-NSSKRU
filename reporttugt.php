                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="container">
                                ...
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            echo $_POST["time"] ,"วินาที";
                                            ?>
                                            </h1><br>
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["time"] <=12) {
                                                echo "ปกติ / ไม่เสี่ยงต่อการหกล้ม"; 
                                            }else if ($_POST["time"] >=12){
                                                echo "มีความเสี่ยงต่อภาวะหกล้ม";  
                                                echo "<br/>";
                                                echo "ควรฝึกการทรงตัว ออกกำลังกาย";
                                            }else if ($_POST["time"] >=30){
                                                echo "มีความเสี่ยงต่อภาวะหกล้ม";  
                                                echo "<br/>";
                                                echo "ควรได้รับคำแนะนำจากบุคลากรทางการแพทย์ และป้องกันภาวะหกล้ม";
                                            }
                                            ?>
                                            </h3><br>
                                        </div>
                            ...
                            <lu>
                                <li>ผู้สูงอายุใช้เวลาในการเดินน้อยกว่าหรือเท่ากับ 12 วินาที ถือว่า ปกติ/ไม่เสี่ยงต่อการล้ม </li>

                                <li>
                                    ผู้สูงอายุใช้เวลาในการเดินตั้งแต่ 12 วินาทีขึ้นไป ถือว่ามีความเสี่ยงต่อภาวะหกล้ม ควรได้รับคำแนะนำจากบุคลากรทางการแพทย์และป้องกันภาวะหกล้ม </li>
                            </lu>
                            </div>
                        </div>
                    </form>
                    <hr>
                    <p class="text-right">ที่มา : 1.) สถาบันเวชศาสตร์สมเด็จพระสังฆราชญาณสังวรเพื่อผู้สูงอายุ กรมการแพทย์ กระทรวงสาธารณสุข แนวทางเวชปฏิบัติการป้องกันและประเมินภาวะหกล้มในผู้สูงอายุ, 2562 <br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2.) คณะกรรมการพัฒนาเครื่องมือคัดกรองและประเมินสุขภาพผู้สูงอายุกระทรวงสาธารณสุข คู่มือคัดกรองและประเมินสุขภาพผู้สูงอายุ, 2564
