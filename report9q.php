            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แบบประเมินโรคซึมเศร้า 9 คำถาม (9Q)</h1>
                    </div>
                        <div class="container">
                            <div class="row">
                                <!-- <div class="col"></div> -->
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            $_POST["eight"];
                                            $_POST["nine"];
                                            echo $_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"];
                                            ?>
                                            </h1><br>
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"] >=19) {
                                                echo "มีอาการโรคซึมเศร้า";
                                                echo "<br/>";
                                                echo "ระดับรุนแรง";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"] >=13){
                                                echo "มีอาการโรคซึมเศร้า";
                                                echo "<br/>";
                                                echo "ระดับปานกลาง";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"] >=7){
                                                echo "มีอาการโรคซึมเศร้า";
                                                echo "<br/>";
                                                echo "ระดับน้อย";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"] <=6){
                                                echo "ไม่มีอาการโรคซึมเศร้า";
                                                echo "<br/>";
                                                echo "หรือ";
                                                echo "<br/>";
                                                echo "ระดับน้อยมาก";
