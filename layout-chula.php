...
<html lang="en">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">แบบประเมินความสามารถเชิงปฏิบัติดัชนีจุฬาเอดีแอล (Chula ADL Index)</h1>
    ...
    <hr>
    <div class="row">
        <p class="text-right">ที่มา : Jitapunkuls,et al. The meaning of activity of daily living in a Thai elderly population:
            development of a new index. Age Ageing. 1994 </p>
