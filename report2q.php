            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แบบคัดกรองโรคซึมเศร้า 2 คำถาม (2Q)</h1>
                    </div>
                        <div class="container">
                            <div class="row">
                                <!-- <div class="col"></div> -->
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"]>=1) {
                                                echo "มีแนวโน้มที่จะเป็นโรคซึมเศร้า";
                                            }else {
                                                echo "ปกติ";
                                                echo "<br/>";
                                                echo "ยังไม่เป็นโรคซึมเศร้า";
                                            }
                                            ?>
                                            </h3><br>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-dark" role="alert">
                                ...
                                <hr>
                                <h5>
                                    <label>- ถ้าคำตอบ <label class="text-danger alert-link"> ไม่มี </label> ทั้ง 2 คำถาม ถือว่า ปกติ ไม่เป็นโรคซึมเศร้า <br>
                                    <label>- ถ้าคำตอบ <label class="text-danger alert-link">มี</label> ข้อใดข้อหนึ่งหรือทั้ง 2 ข้อ (มีอาการใดๆ ในคำถามข้อที่ 1 และ 2) หมายถึง <label class="text-danger alert-link">"เป็นผู้มีความเสี่ยง" หรือ "มีแนวโน้มที่จะเป็นโรคซึมเศร้า"</label> <br><a href="layout-9q.php">ให้ประเมินต่อด้วยแบบประเมินโรคซึมเศร้า 9Q</a></label><br>
                                </h5>
                            </div>
                        </div>
                    </form>
