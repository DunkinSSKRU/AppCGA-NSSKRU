...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">การคัดกรองภาวะกลั้นปัสสาวะ</h1>

    </div>

    <!-- Content Row ###############################################################-->
    <hr>
    <form name="assessment" action="reportincon.php" method="post" enctype="multipart/form-data">
        <div class="table-responsive shadow">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead class="alert-primary">
                    <tr class="text-center">
                        <th>ภาวะกลั้นปัสสาวะ</th>
                        <th>ไม่มี</th>
                        <th>มี</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>1. ท่านมีภาวะ "ปัสสาวะเล็ด" หรือ "ปัสสาวะราด" จนทำให้เกิดปัญหาในการใช้ชีวิตประจำวัน</td>
