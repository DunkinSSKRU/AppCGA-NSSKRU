...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">การประเมินสิ่งแวดล้อม (Environment Assessment)</h1>
        ...
        <div class="">
            <div class="card">
                <div class="card-body">
                <center><img class="card-img-top" src="assessment-envi1.png" alt="Card image cap"></center><br>
                <center><img class="card-img-top" src="assessment-envi2.png" alt="Card image cap"></center><br>
                <center><img class="card-img-top" src="assessment-envi3.png" alt="Card image cap"></center><br>
                <center><img class="card-img-top" src="assessment-envi4.png" alt="Card image cap"></center><br>
                <center><img class="card-img-top" src="assessment-envi5.png" alt="Card image cap"></center><br>
                <center><img class="card-img-top" src="assessment-envi6.png" alt="Card image cap"></center><br>
                <center><img class="card-img-top" src="Environment.png" alt="Card image cap"></center>         
<div class="row">
