        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row ###############################################################-->
                    <hr>
                    <form name="assessment" action="reportcsl.php" method="post" enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="three" id="three1"
                                                    value="1">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="three" id="three2"
                                                    value="0" checked>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="eleven" id="eleven1"
                                                    value="1">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="eleven" id="eleven2"
                                                    value="0" checked>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>12.เป็นเรื่องความตึงเครียดทางด้านการเงิน</td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="twelve" id="twelve1"
                                                    value="1">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="twelve" id="twelve2"
                                                    value="0" checked>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>13.มีความรู้สึกว่าเรื่องราวต่าง ๆ ประดังเข้ามา (เช่น กังวลเกี่ยวกับผู้สูงอายุ เป็นห่วงว่าดิฉันจะจัดการได้อย่างไร)</td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="thirteen" id="thirteen1"
                                                    value="1">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="thirteen" id="thirteen2"
                                                    value="0" checked>
                                            </div>
                                        </td>
                                    </tr>
