                                ...
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            $_POST["bowels"];
                                            $_POST["bladder"];
                                            echo $_POST["feed"]+$_POST["groom"]+$_POST["transfer"]+$_POST["toilet"]+$_POST["mobility"]+$_POST["dress"]+$_POST["stairs"]+$_POST["bath"]+$_POST["bowels"]+$_POST["bladder"];
                                            ?>
                                            </h1><br>
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["feed"]+$_POST["groom"]+$_POST["transfer"]+$_POST["toilet"]+$_POST["mobility"]+$_POST["dress"]+$_POST["stairs"]+$_POST["bath"]+$_POST["bowels"]+$_POST["bladder"] >=12 ) {
                                                echo "ผู้สูงอายุกลุ่มที่ 1 (กลุ่มติดสังคม) พึ่งตนเองได้ ช่วยเหลือผู้อื่น ชุมชน และสังคมได้";
                                                echo "<br/>";
                                                echo "ควรประเมินอย่างน้อยปีละ 1 ครั้ง ขึ้นอยู่กับสภาพการเปลี่ยนแปลงของผู้สูงอายุ";
                                            }else if ($_POST["feed"]+$_POST["groom"]+$_POST["transfer"]+$_POST["toilet"]+$_POST["mobility"]+$_POST["dress"]+$_POST["stairs"]+$_POST["bath"]+$_POST["bowels"]+$_POST["bladder"] >=5 ) {
                                                echo "ผู้สูงอายุกลุ่มที่ 2 (กลุ่มติดบ้าน) ดูแลตัวเองได้บ้าง ช่วยเหลือตนเองได้บ้าง";
                                                echo "<br/>";
                                                echo "ควรประเมินอย่างน้อยปีละ 1 ครั้ง ขึ้นอยู่กับสภาพการเปลี่ยนแปลงของผู้สูงอายุ";
                                            }else {
                                                echo "ผู้สูงอายุกลุ่มที่ 3 (กลุ่มติดเตียง) พึ่งตนเองไม่ได้ ช่วยเหลือตนเองไม่ได้ พิการหรือทุพพลภาพ";
                                                echo "<br/>";
                                                echo "ควรประเมินอย่างน้อยปีละ 1 ครั้ง ขึ้นอยู่กับสภาพการเปลี่ยนแปลงของผู้สูงอายุ";
                                            }
                                            ?>
