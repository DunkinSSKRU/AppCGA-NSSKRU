            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="container">
                            <div class="row">
                                <img src="assessment-eye4.png" class="rounded float-left" alt="...">
                                <img src="assessment-eye5.png" class="rounded float-left" alt="...">
                                <img src="assessment-eye6.png" class="rounded float-left" alt="...">
                                <img src="assessment-eye7.png" class="rounded float-left" alt="...">
                                <img src="assessment-eye8.png" class="rounded float-left" alt="...">
                                <img src="assessment-eye9.png" class="rounded float-left" alt="...">
                            </div>
                        </div>
                            <hr>
