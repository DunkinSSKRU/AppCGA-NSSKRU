                                ...
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"] ==0) {
                                                echo "ยังไม่พบอาการผิดปกติ";
                                            
                                            }else {
                                                echo "ควรพบแพทย์ตรวจวินิจฉัยเพื่อยืนยันผลและทำการรักษา";
                                                echo '<img src="/เว็บ/startbootstrap-sb-admin-gh-pages/startbootstrap-sb-admin-gh-pages/assessment-sleep.png">';
