                                ...
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            $_POST["one1"];
                                            $_POST["two1"];
                                            echo $_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"]+$_POST["ten"]+$_POST["one1"]+$_POST["two1"];
                                            ?>
                                            </h1><br>
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"]+$_POST["ten"]+$_POST["one1"]+$_POST["two1"] >=40) {
                                                echo "ยังไม่พบอาการผิดปกติ";
                                                echo "<br/>";
                                                echo "แต่ควรตรวจร่างกายเป็นประจำทุกปี";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"]+$_POST["ten"]+$_POST["one1"]+$_POST["two1"] >=30){
                                                echo "พบเริ่มมีอาการของโรคข้อเข่าเสื่อม";
                                                echo "<br/>";
                                                echo "ควรได้รับคำแนะนำจากศัลยแพทย์ผู้เชี่ยวชาญกระดูกและข้อ เรื่องการออกกำลังกายอย่างเหมาะสม การควบคุมนำ้หนักเพื่อไม่ให้อ้วน หลีกเลี่ยงท่าหรือกิจกรรมที่จะทำให้เกิดอาการและความรุนแรงของโรคมากขึ้น และการประเมินระดับอาการของโรค";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"]+$_POST["ten"]+$_POST["one1"]+$_POST["two1"] >=20){
                                                echo "มีโอกาสเป็นโรคข้าเข่าเสื่อมระดับปานกลาง";
                                                echo "<br/>";
                                                echo "ควรปรึกษาศัลยแพทย์ผู้เชี่ยวชาญกระดูกและข้อ เพื่อรับการตรวจรักษาเอกซเรย์ ข้อเข่า และประเมินอาการของโรค";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"]+$_POST["seven"]+$_POST["eight"]+$_POST["nine"]+$_POST["ten"]+$_POST["one1"]+$_POST["two1"] <=19){
                                                echo "เป็นโรคข้อเข่าเสื่อมระดับรุนแรง";
                                                echo "<br/>";
                                                echo "ควรรับการรักษาจากศัลยแพทย์ผู้เชี่ยวชาญกระดูกและข้อทันที";
                                            }
                                            ?>
                                            </h3><br>
                                        </div>
