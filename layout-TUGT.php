                ...
                <main>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h2 class="h3 mb-0 text-gray-800">การประเมินภาวะหกล้ม (Time up and go Test :TUGT)</h2>
                        </div>
                        <!-- Content Row ###############################################################-->
                        <div class="container">
                        <div class="row">
                            <img src="tugt.png" class="img-fluid" alt="...">
                        </div>
                        <br>
                        <hr>
                        <div class="row">
                            <form name="assessment" action="reporttugt.php" method="post" enctype="multipart/form-data">
                                <div class="row g-3 align-items-center">
                                    
                                    <div class="col-auto">
                                        <label for="inputPassword6" class="col-form-label">เวลาที่ได้</label>
                                    </div>
                                    <div class="col-auto">
                                        <input type="text" id="inputPassword6" class="form-control"
                                            aria-describedby="passwordHelpInline" name="time">
                                    </div>
                                    <div class="col-auto">
