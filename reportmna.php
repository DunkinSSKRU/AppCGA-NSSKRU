                        ...
                        <div class="container">
                                ...
                                <div class="col">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="card-body"><h1 class="card-title">
                                            ...
                                            $_POST["five"];
                                            $_POST["six"];
                                            echo $_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"];
                                            ?>
                                            </h1><br>
                                            <h3 class="card-title">
                                            <?php 
                                            if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"] >=12) {
                                                echo "โภชนาการปกติ";
                                            }else if ($_POST["one"]+$_POST["two"]+$_POST["tree"]+$_POST["four"]+$_POST["five"]+$_POST["six"] >=8){
                                                echo "เสี่ยงต่อภาวะการขาดสารอาหาร";
                                            }else {
                                                echo "ขาดสารอาหาร";
                                            }
                                            ?>
                            ...
                            <div class="col-md-12">
                                <div class="alert alert-dark" role="alert">
                                    ...
                                    </h4><h5>คะแนนเต็ม 14 คะแนน หากคะแนนรวม น้อยกว่าหรือเท่ากับ 11 ให้ประเมินด้วย MNA (Full form)</h5><br>
                                    <a class="text-link text-danger" href="https://www.mna-elderly.com/sites/default/files/2021-10/MNA-thai.pdf">MNA (Full form)</a>
                                </div>
                            </div>
                            </div>
