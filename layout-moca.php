            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แบบประเมินพุทธิปัญญา (MoCA)</h1>
                    ...
                    <div class="container">
                        <div class="row">
                            <img src="assessment-MoCA1.png" class="img-fluid" alt="..."> <br>
                            <img src="assessment-MoCA2.png" class="img-fluid" alt="...">
                        </div>
                    </div>
                    <div class="row">
                        <h4 style="margin-top: 1rem;">
                            การพิจารณา </h4><br>
                        <h4 style="margin-top: 1rem;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หากมีคะแนนตำกว่าปกติ แสดงว่ามีภาวะสมองเสื่อมถดถอยด้านรู้คิด ให้ส่งต่อแพทย์ตรวจวินิจฉัยและทำการรักษา
                        </h4>
                    </div>   
                    <br>                 
<div class="row">
